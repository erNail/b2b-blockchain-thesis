...
%TODO: Private und Public Key genauer erklären ? Bild entfernen ?
...
%TODO: Bilder Weltkarte kleiner und hintereinander
\begin{figure}[!htbp]
  \centering
...
%TODO: BFT-Protokolle: Footnode oder Hinweis das später genauer drauf eingegangen wird
\begin{table}[h]
    \centering
...
%TODO: Beispiele in Paragraphs unterteilen
...
%SoldatosWhatDoes Supply Chain Explanation ?
%S.3 WustYouNeed Supply Chain Explanation ?
