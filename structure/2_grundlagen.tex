...
\begin{table}[h]
    ...
    \end{tabular}
    \caption{Vergleich der Blockchaintypen mit Datenbanksystemen. Die erwähnten \acs{BFT}-Protokolle werden genauer im Kapitel \ref{sec:eval-konsens} erläutert \cite{WustyouneedBlockchain2017}\cite{ZhengBlockchainChallengesOpportunities2017}.}
