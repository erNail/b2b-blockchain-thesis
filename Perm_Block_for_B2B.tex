...
%----------------- PDF CONFIG ----------------- %
\pdfinfo{    
     /Title (Permissioned Blockchains für B2B-Anwendungen - Prototypische Implementierung einer B2B-Anwendung) 
     /Subject   (Permissioned Blockchains)    
     /Author  (Eric Nagel) 
     /Keywords   (Blockchain, B2B)      
}

\title{Permissioned Blockchains für B2B-Anwendungen - Prototypische Implementierung einer B2B-Anwendung}
\author{Eric Nagel}
\date{09.03.2018}
