...
\include{structure/3_wartungsmarkt-konzept}
\include{structure/4_stand-technik}
\include{structure/5_b2b-eval}
\include{structure/6_wartungsmarkt-impl}
\include{structure/7_evaluierung}
\include{structure/8_fazit}
